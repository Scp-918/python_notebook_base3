...
def _acc3_compare_fields(metrics: dict[str, Any], *, status: str, reason: str) -> dict[str, Any]:
    return {
        ...
        "acc3_compare_posthoc_final_aae_bpm": metrics.get("posthoc_final_aae_bpm", float("nan")),
        "acc3_compare_posthoc_final_acc_pct": metrics.get("posthoc_final_acc_pct", float("nan")),
...
def _empty_acc3_compare_fields(status: str = "", reason: str = "") -> dict[str, Any]:
    return {
        ...
        "acc3_compare_posthoc_final_aae_bpm": float("nan"),
        "acc3_compare_posthoc_final_acc_pct": float("nan"),
...
def _mode_done_progress_payload(
    ...
    *,
    ...
    return {
        ...
        "current_posthoc_final_aae_bpm": metrics.get("posthoc_final_aae_bpm"),
        "current_posthoc_final_acc_pct": metrics.get("posthoc_final_acc_pct"),
        ...
        "acc3_compare_posthoc_final_aae_bpm": acc3_metrics.get("acc3_compare_posthoc_final_aae_bpm"),
        "acc3_compare_posthoc_final_acc_pct": acc3_metrics.get("acc3_compare_posthoc_final_acc_pct"),
...
def _best_params_alignment_columns() -> list[str]:
    return [
        ...
        "acc3_compare_aae_bpm", "acc3_compare_accuracy_pct",
        "acc3_compare_posthoc_final_aae_bpm", "acc3_compare_posthoc_final_acc_pct",
...
def _batch_compare_run_fields(prefix: str, run: ProtocolRunResult) -> dict[str, Any]:
    ...
    return {
        ...
        f"{prefix}_posthoc_final_aae_bpm": float(run.posthoc_final_aae_bpm),
        f"{prefix}_posthoc_final_accuracy_pct": float(run.posthoc_final_acc_pct),
...
def _empty_batch_compare_run_fields(prefix: str, reason: str) -> dict[str, Any]:
    return {
        ...
        f"{prefix}_posthoc_final_aae_bpm": float("nan"),
        f"{prefix}_posthoc_final_accuracy_pct": float("nan"),
...
def _batch_reference_compare_columns() -> list[str]:
    return [
        ...
        "source_posthoc_final_aae_bpm",
        "source_posthoc_final_accuracy_pct",
        ...
        "actual_posthoc_final_aae_bpm",
        "actual_posthoc_final_accuracy_pct",
